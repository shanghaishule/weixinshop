...
class upmp_config
{
    ...
    static $mer_back_end_url     	= "http://bestchoice88.com/weTall/wapupay/notify_url.php"; // 后台通知地址
    static $mer_front_end_url     	= "http://bestchoice88.com/weTall/wapupay/notify_url.php"; // 前台通知地址
