...
<body>
<div class="main">
    <div class="top" onclick="viewExplan();"><div class="k">微信添加微信号：<strong>蜀乐订餐</strong> <br>发送<?php include"../config.php"; echo $huati;?>任意文字即可实时上墙！</div></div>
	<div class="wall">
		<div class="left"></div>
		<div class="center">
			<div class="list">
	...
	<div id="explan" style="display:none" onclick="viewExplan();"><p><b style="font-size:50px;">上墙方法：</b><br />1.微信添加微信号：蜀乐订餐<br />2.发送<?php include"../config.php"; echo $huati;?>+您想说的话即可上墙！</p></div>
</div>
...
var mtime;
var data=new Array();
data[0]=new Array('0','http://bcs.duapp.com/yuntuchuang1/JyJotr0Qgw.jpg','管理员说','欢迎来到微信上墙，记得要积极发言哦！这里显示最新的4条开始自己刷新的哟');
