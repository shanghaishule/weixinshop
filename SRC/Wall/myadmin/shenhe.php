		...
		<div class="notification attention png_bg"> <a href="#" class="close"><img src="themes/images/icons/cross_grey_small.png" title="Close this notification" alt="close" /></a>
          ...
          <table class="table">
		   <thead>
			...
			<th>内容</th>
			<th>审核</th>
			<th>全选<input type="checkbox"  id="checkedAll" onclick='check_all(this,"check[]")'/></th>
			</tr>
		   </thead>
		   <?php
		   include("db.php");
		   
			$Page_size=15; //设置每页显示多少条
...
?> 
			...
			<tr>
				...
				<th><input type="checkbox" name="check[]" value="<?=$q[0]?> " /></th>
			</tr>
			<?php }
...
function check_all(obj,cName)
{
    ...
    for(var i=0;i<checkboxs.length;i++){checkboxs[i].checked = obj.checked;}
          ...
          <div><br/><center>
			<input type="submit" value="PASS" class="button"/><input type="submit" value="DEL" class="button"/></a>
			<center></div>
            </form>
