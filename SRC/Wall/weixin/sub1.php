...
xml;
parse_str($xml);
//echo  "title|【{$nickname}】欢迎关注我们的平台#pic|http://f.hiphotos.baidu.com/pic/w%3D230/sign=a34574e90d3387449cc5287f610ed937/30adcbef76094b36f9ce3154a2cc7cd98d109d2e.jpg@title|1.\t上墙#pic|@title|2.\t投票#pic|{$wxhead}@title|回复对应的数字进入对应的模块#pic|@title|回复【取消】或【退出】返回主菜单";//开场百
