...
defined('CORE_PATH')    or define('CORE_PATH',      THINK_PATHSLAPP.'Lib/'); // 系统核心类库目录
defined('EXTEND_PATH')  or define('EXTEND_PATH',    THINK_PATHSLAPP.'Extend/'); // 系统扩展目录
...
function load_runtime_file() {
    // 加载系统基础函数库
    require THINK_PATHSLAPP.'Common/common.php';
    // 读取核心编译文件列表
    $list = array(
    ...
    // 加载系统类库别名定义
    alias_import(include THINK_PATHSLAPP.'Conf/alias.php');
...
function build_runtime_cache($append='') {
    ...
    // 读取核心编译文件列表
    $list = array(
        THINK_PATHSLAPP.'Common/common.php',
        CORE_PATH.'Core/Think.class.php',
    ...
    $alias      = include THINK_PATHSLAPP.'Conf/alias.php';
...
function build_first_action() {
    $content = file_get_contents(THINK_PATHSLAPP.'Tpl/default_index.tpl');
