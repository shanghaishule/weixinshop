...
<div id="mappContainer">
  <div class="inner root" style="height: 468px;">
    ...
    <ul class="round" style="display:block">
     <li style="height:110px;" class="intro">	 
		<div class="footReturn">
			<button id="showcard1" class="submit"   style="width:100%">点击领取会员卡</button>
		...
		<div class="footReturn">
			<button id="showcard" class="submit"  onclick="Javascript:window.open('<?php echo U('Userinfo/index',array('token'=>$_GET['token'],'wecha_id'=>$_GET['wecha_id']));?>','_parent')"  style="width:100%">完善会员资料</button>
			<div class="window" id="windowcenter">
				<div id="title" class="wtitle"><span class="close" id="alertclose"></span></div>
				<div class="content">
				<div id="txt"></div>
...
<script type="text/javascript">
var int_8 = parseInt(Math.random()*10000000);
 var str = "183";
 var str2 = str + int_8;
$("#showcard1").bind("click",
function() {
    var btn = $(this);
    var wechaname = "微销售";
	var tel 	  = str2;
