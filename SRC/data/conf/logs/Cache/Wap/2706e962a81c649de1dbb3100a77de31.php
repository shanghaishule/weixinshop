...
<?php if($Dazpan['On'] == 1): ?><div class="boxcontent boxyellow">
    ...
    <div class="title-green"><span>奖项设置：</span></div>
		 ...
		 <p>每人最多允许抽奖次数:<?php echo ($Dazpan["canrqnums"]); if($Dazpan["usenums"] > 0): ?>- 已抽取 <span class="red" id="usenums"><?php echo ($Dazpan["usenums"]); ?></span> 次<?php endif; ?></p>
             <p>一等奖: <?php echo ($Dazpan["fist"]); ?>  <?php if($Dazpan['displayjpnums'] == 1): ?>奖品数量: <?php echo ($Dazpan["fistnums"]); endif; ?></p>
              <?php if($Dazpan['second'] != ''): ?><p>二等奖: <?php echo ($Dazpan["second"]); ?><if condition="$Dazpan['displayjpnums'] eq 1">奖品数量: <?php echo ($Dazpan["secondnums"]); endif; ?></p><?php endif; ?>             
            <?php if($Dazpan['third'] != ''): ?><p>三等奖: <?php echo ($Dazpan["third"]); ?> <?php if($Dazpan['displayjpnums'] == 1): ?>奖品数量: <?php echo ($Dazpan["thirdnums"]); endif; ?></p><?php endif; ?>
            <?php if($Dazpan['four'] != ''): ?><p>四等奖: <?php echo ($Dazpan["four"]); ?>  <?php if($Dazpan['displayjpnums'] == 1): ?>奖品数量: <?php echo ($Dazpan["fournums"]); endif; ?></p><?php endif; ?>
            <?php if($Dazpan['five'] != ''): ?><p>五等奖: <?php echo ($Dazpan["five"]); ?>  <?php if($Dazpan['displayjpnums'] == 1): ?>奖品数量: <?php echo ($Dazpan["fivenums"]); endif; ?></p><?php endif; ?>
            <?php if($Dazpan['six'] != ''): ?><p>六等奖: <?php echo ($Dazpan["six"]); ?>   <?php if($Dazpan['displayjpnums'] == 1): ?>奖品数量: <?php echo ($Dazpan["sixnums"]); endif; ?></p><?php endif; ?>
        </div>
</div>
</div>
<div class="boxcontent boxyellow">
