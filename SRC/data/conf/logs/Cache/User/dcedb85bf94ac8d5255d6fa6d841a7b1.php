...
<div class="mediaImg"><img id="zpic" src="<?php echo ($photo["picurl"]); ?>"></div>
...
<td width="430"><input type="text" name="picurl" value="<?php echo ($photo["picurl"]); ?>" class="px" style="width:400px;" id="pic" onblur="document.getElementById('zpic').src=document.getElementById('pic').value;document.getElementById('zpic2').src=document.getElementById('pic').value;">
<br>									
外链图片地址，尺寸720×400.</td>
</tr>
<tr>
   <th valign="top">相册介绍：</th>
	<td valign="top">
		...
		<label>
			<input name="isshoinfo" <?php if($photo['isshoinfo'] == 0): ?>checked="checked"<?php endif; ?> type="radio" id="RadioGroup0_0" value="0" checked="checked" onclick="document.getElementById('photo2').style.display='none';document.getElementById('photo1').style.display='';">
			显示简介
		</label>　　
		<label>
			<input type="radio" <?php if($photo['isshoinfo'] == 1): ?>checked="checked"<?php endif; ?> name="isshoinfo" value="1" id="RadioGroup0_1" onclick="document.getElementById('photo1').style.display='none';document.getElementById('photo2').style.display='';">
			不显示简介
		</label>	
	</td>
</tr>
...
<th valign="top">是否显示：</th>
	<td valign="top">							
		<label>
		<input name="status" type="radio" <?php if($photo['status'] == 0): ?>checked="checked"<?php endif; ?> id="RadioGroup1_0" value="0">
		显示此相册</label>　　<label>
		<input type="radio" <?php if($photo['status'] == 1): ?>checked="checked"<?php endif; ?> name="status" value="1" id="RadioGroup1_1">
		不显示此相册</label>                            	
	</td>
</tr>
<tr>
