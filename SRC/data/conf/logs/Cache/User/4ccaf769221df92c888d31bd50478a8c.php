...
<!-- ----------------------------------------------------------------------------------------------------------------------------------------------------- -->
	...
	<div id="Content" >
        ...
        <div class="content" style="width:920px; background:none; margin-left:275px; border:none; margin-bottom:30px;" >
          <div class="cLineB">
              <h4 class="left">微调研 设置问题 (<?php echo ($count); ?>) 条<span class="FAQ">你本月有 <?php echo ($group["activitynum"]); ?> 次机会可免收活动创建费，已经使用了 <?php echo ($activitynum); ?> 次机会!</span></h4>
                 
              <div class="clr"></div>
          </div>
          <div class="cLine">
            <div class="pageNavigator left">
  <a href='<?php echo U('Diaoyan/add',array('token'=>$token));?>' title='新增调研问题' class='btnGrayS vm bigbtn'><img src="<?php echo RES;?>/images/product/add.png" class="vm" />新增调研问题</a>
...
<TH class="norightborder">操作</TH>
              ...
              <TBODY>
                <TR></TR>
                  ...
                  <TD><input type="checkbox" name='del_id[]' <?php if($list['display'] == 'Y'): ?>checked<?php endif; ?> value="842" class="checkitem"></TD>
				  <TD><?php if($list['type'] == 'D'): ?>单选<?php else: ?>多选<?php endif; ?></TD>
                  <TD><?php echo ($list["question"]); ?></TD>
                  
                   <TD class="norightborder">
				   
				   <a href="index.php?g=User&m=Diaoyan&a=edit&id=<?php echo ($list["id"]); ?>">编辑</a>  				  
				   <a href="index.php?g=User&m=Diaoyan&a=delete&id=<?php echo ($list["id"]); ?>">删除</a>
				   <a href="index.php?g=User&m=Diaoyan&a=answer&id=<?php echo ($list["id"]); ?>">选票情况</a></TD>
