	  ...
	  <form class="form" method="post" action="" target="_top" enctype="multipart/form-data">	 
		<table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%">
			<tbody>
				...
				<tr>
					<th>回复图片：</th>
					<td><input type="text" name="picurl" value="<?php echo ($home["picurl"]); ?>" id="pic" class="px" style="width:550px;" readonly="readonly"><span class="ke-button-common" id="upload" style="margin-top: 3px;margin-left: 5px;"><input type="button" class="ke-button-common ke-button" value="上传"></span><br/> 填写图片外链地址，大小为720x400</td>
				</tr>
				<th>&nbsp;</th>
					<td>
