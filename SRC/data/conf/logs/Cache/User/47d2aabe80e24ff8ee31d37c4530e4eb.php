...
<!--活动开始-->
<div class="cLineB">
  <h4>编辑微调研问题</h4><a href="javascript:history.go(-1);" class="right btnGrayS vm" style="margin-top:-27px">返回</a></div>  
<div class="msgWrap bgfc">
 
<table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%"><tbody>
<tr>
  <th valign="top"><span class="red">*</span>问题：</th>
  <td>
  <input type="hidden" name="id" value="<?php echo ($quesob["id"]); ?>" />
  <input type="input" class="px" id="question" value="<?php echo ($quesob["question"]); ?>" name="question" style="width:500px"></td>
</tr><tr>
  <th valign="top"><span class="red">*</span>A：</th>
  <td><input type="input" class="px" id="a" value="<?php echo ($quesob["optionA"]); ?>" name="questionA" style="width:500px"></td>
</tr><tr>
  <th valign="top"><span class="red"></span>B：</th>
  <td><input type="input" class="px" id="b" value="<?php echo ($quesob["optionB"]); ?>" name="questionB" style="width:500px"></td>
</tr><tr>
  <th valign="top"><span class="red"></span>C：</th>
  <td><input type="input" class="px" id="c" value="<?php echo ($quesob["optionC"]); ?>" name="questionC" style="width:500px"></td>
</tr><tr>
  <th valign="top"><span class="red"></span>D：</th>
  <td><input type="input" class="px" id="d" value="<?php echo ($quesob["optionD"]); ?>" name="questionD" style="width:500px"></td>
</tr><tr>
  <th valign="top"><span class="red"></span>E：</th>
  <td><input type="input" class="px" id="e" value="<?php echo ($quesob["optionE"]); ?>" name="questionE" style="width:500px"></td>
</tr><tr>
  <th valign="top"><span class="red"></span>显示在微网站上：</th>
  <td><input type="checkbox" class="px" <?php if($quesob['display'] == 'Y'): ?>checked<?php endif; ?>  name="display"></td>
 </tr><tr>
  <th valign="top"><span class="red"></span>问题类型：</th>
  <td><input type="radio" value="D" class="px" <?php if($quesob['type'] == 'D'): ?>checked<?php endif; ?>  name="type">   单选</input>
      <input value="S" style="margin-left:42px;" <?php if($quesob['type'] == 'S'): ?>checked<?php endif; ?> type="radio" class="px"  name="type">   多选</input></td>
    
</tr>

<tr>
<th>&nbsp;</th>
<td><button type="submit" name="button" class="btnGreen">保存</button>　<a href="index.php?g=User&m=Diaoyan&a=index" class="btnGray vm">取消</a></td>
                                    </tr>
</tbody>
</table>
</div> 
