...
<?php if($isUpdate == 1): ?><input type="hidden" name="id" value="<?php echo ($set["id"]); ?>" /><?php endif; ?>
    <div class="msgWrap bgfc"> 
     ...
     <tr> 
        ...
        <td><input type="text" name="pic" value="<?php echo ($set["pic"]); ?>" id="pic" class="px" style="width:400px;"  readonly="readonly"/><span class="ke-button-common" id="upload_pic" style="margin-top: 3px;margin-left: 5px;"><input type="button" class="ke-button-common ke-button" value="上传"></span></td> 
       </tr>
     <tr> 
	   ...
	   <tr> 
        ...
        <td><input type="text" name="small_pic" value="<?php echo ($set["small_pic"]); ?>" id="small_pic" class="px" style="width:400px;"  readonly="readonly"/><span class="ke-button-common" id="upload_small_pic" style="margin-top: 3px;margin-left: 5px;"><input type="button" class="ke-button-common ke-button" value="上传"></span></td> 
       </tr>
     <tr> 
     ...
     <tr> 
	   ...
	   <tr> 
        ...
        <td><input type="text" name="site_map_1" value="<?php echo ($set["site_map_1"]); ?>" id="site_map_1" class="px" style="width:400px;"  readonly="readonly"/><span class="ke-button-common" id="upload_site_map_1" style="margin-top: 3px;margin-left: 5px;"><input type="button" class="ke-button-common ke-button" value="上传"></span></td> 
       </tr>
	   <tr> 
        <th><span class="red"></span>场地图(二)：</th>
        <td><input type="text" name="site_map_2" value="<?php echo ($set["site_map_2"]); ?>" id="site_map_2" class="px" style="width:400px;"  readonly="readonly"/><span class="ke-button-common" id="upload_site_map_2" style="margin-top: 3px;margin-left: 5px;"><input type="button" class="ke-button-common ke-button" value="上传"></span></td> 
       </tr>
	   <tr> 
        <th><span class="red"></span>场地图(三)：</th>
        <td><input type="text" name="site_map_3" value="<?php echo ($set["site_map_3"]); ?>" id="site_map_3" class="px" style="width:400px;"  readonly="readonly"/><span class="ke-button-common" id="upload_site_map_3" style="margin-top: 3px;margin-left: 5px;"><input type="button" class="ke-button-common ke-button" value="上传"></span></td> 
       </tr>
	   <tr> 
        <th><span class="red"></span>场地图(四)：</th>
        <td><input type="text" name="site_map_4" value="<?php echo ($set["site_map_4"]); ?>" id="site_map_4" class="px" style="width:400px;"  readonly="readonly"/><span class="ke-button-common" id="upload_site_map_4" style="margin-top: 3px;margin-left: 5px;"><input type="button" class="ke-button-common ke-button" value="上传"></span></td> 
       </tr>
	   <tr> 
        <th><span class="red"></span>场地图(五)：</th>
        <td><input type="text" name="site_map_5" value="<?php echo ($set["site_map_5"]); ?>" id="site_map_5" class="px" style="width:400px;"  readonly="readonly"/><span class="ke-button-common" id="upload_site_map_5" style="margin-top: 3px;margin-left: 5px;"><input type="button" class="ke-button-common ke-button" value="上传"></span></td> 
       </tr>
     <tr>
