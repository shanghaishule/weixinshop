              ...
              <TBODY>
               <TR>
				...
				<TR>
                  ...
                  <TD>（尺寸：宽720像素，高400像素） 小于500k; (不上传不设置系统会自动随机分配)<div><input type="text" value="<?php echo ($info["pic"]); ?>"  class="text textMiddle inputQ" name="pic" id="pic" readonly="readonly" /><span class="ke-button-common" id="upload" style="margin-top: 8px;margin-left: 5px;"><input type="button" class="ke-button-common ke-button" value="上传"></span></div></TD>
                </TR>
