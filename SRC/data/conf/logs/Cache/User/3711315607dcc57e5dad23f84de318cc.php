...
<!-- ----------------------------------------------------------------------------------------------------------------------------------------------------- -->
	...
	<div id="Content" >
        ...
        <div class="content" style="width:920px; background:none; margin-left:275px; border:none; margin-bottom:30px;" >
          <div class="cLineB">
              <h4 class="left">摇一摇设置</span></h4>
                 
              <div class="clr"></div>
          </div>
          <div class="cLine">
            <div class="pageNavigator left">
            <a href='<?php echo U('WechaWall/setWall',array('token'=>$token));?>' title='设置' class='btnGrayS vm bigbtn'><img src="<?php echo RES;?>/images/icons/pencil.png" class="vm" />设置摇一摇</a>
  <a href='<?php echo U('WechaWall/Tozero',array('token'=>$token));?>' title='数据清零' class='btnGrayS vm bigbtn'><img src="<?php echo RES;?>/images/product/cup.png" class="vm" />数据清零</a>
<a href='<?php echo U('WechaWall/gameAgain',array('token'=>$token));?>' title='重新开始' class='btnGrayS vm bigbtn'><img src="<?php echo RES;?>/images/icons/arrow_refresh.png" class="vm" />重新开始</a> 
<a href='<?php echo U('WechaWall/deleteAll',array('token'=>$token));?>' title='删除所有' class='btnGrayS vm bigbtn'><img src="<?php echo RES;?>/images/icons/basket_delete.png" class="vm" />删除所有人</a> 
 <a href='/Wall/vote/index.php?tokenTall=<?php echo ($token); ?>' target="new" title='摇一摇' class='btnGrayS vm bigbtn'><img src="<?php echo RES;?>/images/icons/bell.png" class="vm" />摇一摇</a> 参与人数： <?php echo ($count); ?>    
            </div>
...
<TH>电话号码</TH>
              ...
              <TBODY>
                <TR></TR>
                  ...
                  <TD>第<?php echo ($k); ?>名</TD>                  
                  <TD><?php echo ($list["res"]); ?> </TD>
