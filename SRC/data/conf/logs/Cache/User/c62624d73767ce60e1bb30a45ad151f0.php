               ...
               <tr>
                ...
                <tr>
                 ...
                 <tr>
                  ...
                  <td><input type="text"  name="picurl"  id="pic" value="<?php echo ($taobao["picurl"]); ?>"   class="px" tabindex="1" size="80" readonly="readonly"><span class="ke-button-common" id="upload" style="margin-top: 3px;margin-left: 5px;"><input type="button" class="ke-button-common ke-button" value="上传"></span></td>
                </tr>
                <tr>
