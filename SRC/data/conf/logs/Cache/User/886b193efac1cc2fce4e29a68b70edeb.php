...
<TR>
  ...
  <TD><input type="text" class="px" id="pic" value="" name="img" style="width:500px;" readonly="readonly" ><span class="ke-button-common" id="upload" style="margin-top: 3px;margin-left: 5px;"><input type="button" class="ke-button-common ke-button" value="上传"></span><br />
  </TD>
  <TD>&nbsp;</TD>
</TR>
<TR>
