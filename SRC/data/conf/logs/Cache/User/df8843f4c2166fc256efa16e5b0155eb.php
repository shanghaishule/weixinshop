...
<!--活动开始-->
<div class="cLineB">
  <h4>微调研问题统计结果</h4><a href="javascript:history.go(-1);" class="right btnGrayS vm" style="margin-top:-27px">返回</a></div>  
...
<tr>
  ...
  <label  id="question" ><?php echo ($quesob["question"]); ?></label></td>
</tr><tr>
  <th valign="top"><span class="red">*</span>A：</th>
  <td><label  id="question" ><?php echo ($quesob["optionA"]); ?></label></td>
  <td><label  id="question" ><?php echo ($quesob["answerA"]); ?>票</label></td>
</tr><tr>
  <th valign="top"><span class="red"></span>B：</th>
  <td><label id="question" ><?php echo ($quesob["optionB"]); ?></label></td>
  <td><label  id="question" ><?php echo ($quesob["answerB"]); ?>票</label></td>
</tr><tr>
  <th valign="top"><span class="red"></span>C：</th>
  <td><label id="question" ><?php echo ($quesob["optionC"]); ?></label></td>
  <td><label  id="question" ><?php echo ($quesob["answerC"]); ?>票</label></td>
</tr><tr>
  <th valign="top"><span class="red"></span>D：</th>
  <td><label id="question" ><?php echo ($quesob["optionD"]); ?></label></td>
  <td><label  id="question" ><?php echo ($quesob["answerD"]); ?>票</label></td>
</tr><tr>
  <th valign="top"><span class="red"></span>E：</th>
  <td><label  id="question" ><?php echo ($quesob["optionE"]); ?></label></td>
  <td><label  id="question" ><?php echo ($quesob["answerE"]); ?>票</label></td>
